...
class EnhancedOpenAPIUpdater:
    ...
    def __init__(self):
        ...
        # Создаем директорию для новых спецификаций
    ...
    def create_components_schemas(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        schemas = {
            "ComplexFilter": self.create_complex_filter_schema()
        }
    ...
    def update_specification(self, market: str, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "paths" in spec and f"/{market}/scan" in spec["paths"]:
            ...
            post_operation["requestBody"]["content"] = {
                "application/json": {
        ...
        if any(param.get("is_undocumented") for param in parameters.values()):
            spec["tags"].append({
                "name": "experimental",
                "description": "Experimental and undocumented parameters"
            })
            spec["tags"].append({
                "name": "undocumented",
                "description": "Undocumented API features (use with caution)"
            })
    ...
    def create_base_specification(self, market: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "tags": [
                {
                    "name": market,
                    "description": f"{market_names.get(market, market.title())} API operations"
                },
                {
                    "name": "experimental",
                    "description": "Experimental and undocumented parameters"
    ...
    def update_all_specifications(self):
        ...
        for market, market_data in analysis.get("markets", {}).items():
            ...
            if market_analysis_path.exists():
                ...
                logger.info(f"✅ {market}: {len(parameters)} параметров, {market_data.get('undocumented_parameters', 0)} undocumented")
    ...
    def generate_update_report(self, updated_markets: List[str], total_parameters: int, undocumented_parameters: int):
        ...
        report_path = self.results_dir / "openapi_update_report.json"
